...
--
-- Archmage.elm
-- Chris St. Clair's Archmage board game, in Elm.
...
import Archmage.Types as Types 
    exposing ( Page(..), Msg(..), Board, RenderInfo
             , Move(..), MovedStone(..)
...
import Archmage.Board as Board exposing ( render, isLegalPlacement, makeMove
                                        , computeDisplayList, findResolution
                                        , computeResolutionPile
                                        , placementText, colorLetter
                                        )
import Archmage.Server.EncodeDecode exposing ( decodeMessage
                                             , encodeRestoreState, decodeRestoreState
                                             )
import Archmage.Server.Interface as Interface exposing
